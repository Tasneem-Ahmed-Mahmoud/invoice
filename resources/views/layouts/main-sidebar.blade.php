				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('invoices.invoice_unpaid')  }}">تافواتير الغير مدفوعه</a></li>
							<li><a class="slide-item" href="{{ route('invoices.invoice_partial') }}">الفواتير المدفوعه جزئيا</a></li>
							<li><a class="slide-item" href="{{ route('invoices.invoices_archive') }}">الفواتيرالمؤرشفه</a></li>
						</ul>
					</li>
