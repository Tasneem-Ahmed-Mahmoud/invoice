                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="number"
                                    title="يرجي ادخال رقم الفاتورة" value="{{ $invoice->number }}" required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" @if ($section->id == $invoice->section->id) selected @endif> {{ $section->name }}</option>
                                    @endforeach
                                </select>
                            </div>
