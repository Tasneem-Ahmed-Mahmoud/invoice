	...
	<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<a class="modal-effect btn btn-outline-success w-25" data-effect="effect-scale" data-toggle="modal" href="#modaldemo1">اضافة قسم</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('products.update')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
									<p class="mg-b-10"اسم القسم></p>
									<select name="section_id" id="section_name" class="form-control SlectBox" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
										@foreach ($sections as $section)
										<option value="{{$section->id}}">{{$section->name}}</option>
                                        @endforeach
									</select>
